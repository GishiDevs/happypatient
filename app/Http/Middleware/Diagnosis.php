...
class Diagnosis
{
    ...
    {   
        ...
        if($request->is('diagnosis/create/*') || $request->is('diagnosis/store/*') || $request->is('diagnosis/print/*') || $request->is('diagnosis/edit/*') || $request->is('diagnosis/update/*') || $request->is('diagnosis/view_history/*')){
