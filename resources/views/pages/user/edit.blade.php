                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="form-group col-md-4">
                      ...
                      <textarea class="form-control" rows="3" placeholder="Enter description" name="description" id="description">{{ $user->description }}</textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-4">
                      <label for="license">License</label>
                      <input type="text" id="license" type="text" class="form-control" name="license" value="{{ $user->license }}" placeholder="Enter license">
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-4">
