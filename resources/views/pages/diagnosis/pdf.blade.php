    ...
    <table class="table table-borderless table-sm">
        ...
        <tbody style="border-style: none;">
            <tr style="border-style: none;border-color: rgb(255,255,255);border-top-style: none;">
                <td style="border-style: none;border-color: rgba(33,37,41,0);height: 10px;"></td>
                <td style="width: 25%;border-style: none;border-color: rgb(255,255,255);"></td>
                <td style="width: 25%;border-style: none;border-color: rgb(255,255,255);"><strong style="font-size: 14px;"><em>DATE: </em></strong><span style="font-size: 14px;">Date here</span></td>
                <td style="width: 25%;border-style: none;"><strong style="font-size: 14px;"><em>FILE #: </em></strong><span style="font-size: 14px;">FILE# here</span></td>
            </tr>
            <tr>
                <td style="font-size: 14px;width: 10%;" colspan="4"><strong><em>NAME OF PATIENT: </em></strong><span style="font-size: 14px;">Name here</span></td>
            </tr>
            <tr style="border-style: none;border-color: rgb(255,255,255);border-top-style: none;">
                <td class="text-right" style="border-style: none;border-color: rgb(255,255,255);"><strong style="font-size: 14px;"><em>AGE: </em></strong><span style="font-size: 14px;">Age here</span></td>
                <td class="text-center" style="border-style: none;border-color: rgb(255,255,255);"><strong style="font-size: 14px;"><em>GENDER: </em></strong><span style="font-size: 14px;">TEXT here</span></td>
                <td style="border-style: none;"><strong style="font-size: 14px;"><em>C.S. </em></strong><span style="font-size: 14px;">TEXT HERE</span></td>
            </tr>
            <tr style="border-style: none;border-color: rgb(255,255,255);border-top-style: none;">
                <td class="text-right" style="border-style: none;border-color: rgb(255,255,255);"><strong style="font-size: 14px;"><em>ADDRESS :</em></strong></td>
                <td class="text-left" style="border-style: none;border-color: rgb(255,255,255);padding: 0;padding-top: 4.8PX;" colspan="3"><span style="font-size: 14px;">TEXT here</span></td>
            </tr>
            <tr style="border-style: none;border-color: rgb(255,255,255);border-top-style: none;">
                <td class="text-right" style="border-style: none;border-color: rgb(255,255,255);"><strong style="font-size: 14px;"><em>REFERRING PHYSICIAN: </em></strong></td>
                <td class="text-left" style="border-style: none;border-color: rgb(255,255,255);padding: 0;padding-top: 4.8PX;" colspan="3"><span style="font-size: 14px;">TEXT here</span></td>
            </tr>
            <tr></tr>
            <tr>
            ...
            <tr>
                <td class="text-uppercase text-center text-danger" style="font-size: 12px;text-align: center;" colspan="4"><strong style="font-size: 16px;">template name</strong></td>
            </tr>
            <tr>
                <td colspan="4" style="height: 10px;border-width: 1px;border-bottom-style: solid;"></td>
            </tr>
            ...
            <tr>
                <td class="text-uppercase text-center text-danger" style="font-size: 12px;text-align: center;color: rgb(0,0,0);border-style: none;border-color: rgb(255,255,255);border-top-width: 1px;border-top-color: rgb(0,0,0);border-bottom-color: rgb(0,0,0);"
                    colspan="4">
                    <p style="color: rgb(0,0,0);text-align: left;font-size: 14px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Arcu non odio euismod lacinia at. Non odio euismod lacinia at quis risus sed vulputate odio. Lorem ipsum dolor
                        sit amet consectetur adipiscing elit ut aliquam. Arcu cursus vitae congue mauris rhoncus. Semper quis lectus nulla at. In arcu cursus euismod quis viverra. Sed nisi lacus sed viverra tellus. Dui faucibus in ornare quam viverra.
                        Neque ornare aenean euismod elementum nisi quis eleifend.<br /></p>
                </td>
            </tr>
            <tr>
                <td colspan="4" style="height: 25px;border-style: none;"></td>
